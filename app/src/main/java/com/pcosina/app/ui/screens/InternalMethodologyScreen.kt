...
fun InternalMethodologyScreen(
    ...
    val localFirstStatus = "Profile and pantry inputs stay local-first before planning starts."
        ...
        if (focus == MethodologyFocus.Overview) {
            item {
                RefinedFeatureCard(
                    ...
                    highlights = listOf(
                        "Hard constraints such as allergies, exclusions, cost ceilings, cooking limits, and nutrition bounds stay non-negotiable.",
                        "Pantry entries guide overlap scoring and quantity-aware grocery coverage; they are not treated as a pantry-stock-only requirement.",
        ...
        if (focus == MethodologyFocus.Pipeline) {
            item {
                IpoCard(
                    ...
                    items = listOf(
                        "Profile: age, weight, height, activity level, goals, and optional symptoms",
                        "Hard rules: allergies, exclusions, budget caps when set, and max cooking time",
                        "Local pantry context stays device-first for shopping guidance"
                    ),
            ...
            item {
                IpoCard(
                    ...
                    items = listOf(
                        ...
                        "Allergy families, exclusions, budget/cooking limits, and nutrition feasibility are enforced here",
                        "Pantry overlap is scored for planning guidance and checked for grocery coverage after a plan is built",
            ...
            item {
                IpoCard(
                    ...
                    items = listOf(
                        ...
                        "Shopping outputs stay scoped to the primary-user plan"
                    ),
                    color = colorScheme.primary,
