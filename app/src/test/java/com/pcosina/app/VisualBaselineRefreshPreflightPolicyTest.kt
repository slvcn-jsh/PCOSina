...
class VisualBaselineRefreshPreflightPolicyTest {

    @Test
    fun refreshScript_runsAdbAccessPreflight() {
        val source = read(resolve("scripts", "refresh_visual_baselines.ps1"))
        assertTrue(
            "refresh_visual_baselines script should invoke adb preflight script.",
