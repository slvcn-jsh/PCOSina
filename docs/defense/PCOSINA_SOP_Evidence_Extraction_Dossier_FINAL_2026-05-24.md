...
| Inputs required | Profile, anthropometrics, activity, wellness goal, dietary restrictions, allergies, explicit exclusions, budget, pantry entries, cooking time, variety preference, recipe nutrition, prices, and policy values. |
...
| P0259 | User planning inputs include profile information, dietary restrictions, allergies, food preferences, PCOS-related wellness goals, symptom selections, budget information, pantry items, and planning feedback. These inputs influence candidate filtering, ranking, optimization constraints, grocery guidance, and generated meal-plan outputs. |
...
| PCOS-context variables, such as wellness goals and symptoms | Personalization and reporting context | Target-selection context and non-diagnostic explanation outputs |
...
| Profile Setup Step 3 | Pantry behavior and planning preferences. |
...
| Planner constraints | Budget cap, cooking time, and repetition rules | Pass | Constraint behavior was tested across representative cases. | The planner preserved the two-stage planning behavior and did not relax hard constraints. |
