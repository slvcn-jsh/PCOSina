...
CANONICAL_INGREDIENTS: tuple[CanonicalIngredientSeed, ...] = (
    ...
    CanonicalIngredientSeed("ing_basil", "basil", "produce", "kg", "raw"),
    ...
    CanonicalIngredientSeed("ing_celery", "celery", "produce", "kg", "raw"),
    CanonicalIngredientSeed("ing_chickpea", "chickpea", "legume", "kg"),
    ...
    CanonicalIngredientSeed("ing_cilantro", "cilantro", "produce", "kg", "raw"),
    CanonicalIngredientSeed("ing_corn_oil", "corn oil", "condiment", "l"),
    ...
    CanonicalIngredientSeed("ing_cucumber", "cucumber", "produce", "kg", "raw"),
    ...
    CanonicalIngredientSeed("ing_kidney_bean", "kidney bean", "legume", "kg"),
    CanonicalIngredientSeed("ing_lemon_juice", "lemon juice", "beverage", "l"),
    CanonicalIngredientSeed("ing_lettuce", "lettuce", "produce", "kg", "raw"),
    CanonicalIngredientSeed("ing_malunggay", "malunggay", "produce", "kg", "raw"),
    CanonicalIngredientSeed("ing_mayonnaise", "mayonnaise", "condiment", "kg"),
    CanonicalIngredientSeed("ing_milk", "milk", "dairy", "l"),
    CanonicalIngredientSeed("ing_mussel", "mussel", "fish_seafood", "kg", "raw"),
    CanonicalIngredientSeed("ing_monggo", "monggo", "legume", "kg"),
    CanonicalIngredientSeed("ing_mushroom", "mushroom", "produce", "kg", "raw"),
    ...
    CanonicalIngredientSeed("ing_parsley", "parsley", "produce", "kg", "raw"),
    ...
    CanonicalIngredientSeed("ing_pineapple", "pineapple", "fruit", "kg", "raw"),
    CanonicalIngredientSeed("ing_potato", "potato", "produce", "kg", "raw"),
    ...
    CanonicalIngredientSeed("ing_sardines", "sardines", "fish_seafood", "kg"),
    CanonicalIngredientSeed("ing_scallion", "scallion", "produce", "kg", "raw"),
    CanonicalIngredientSeed("ing_sesame_oil", "sesame oil", "condiment", "l"),
    CanonicalIngredientSeed("ing_sayote", "sayote", "produce", "kg", "raw"),
    CanonicalIngredientSeed("ing_shrimp", "shrimp", "fish_seafood", "kg", "raw"),
    CanonicalIngredientSeed("ing_shrimp_paste", "shrimp paste", "condiment", "kg"),
    ...
    CanonicalIngredientSeed("ing_sweet_potato", "sweet potato", "produce", "kg", "raw"),
    ...
    CanonicalIngredientSeed("ing_annatto_oil", "annatto oil", "condiment", "l"),
    CanonicalIngredientSeed("ing_honey", "honey", "condiment", "kg"),
    CanonicalIngredientSeed("ing_hot_sauce", "hot sauce", "condiment", "l"),
)
...
INGREDIENT_ALIASES: tuple[IngredientAliasSeed, ...] = tuple(
    ...
    for group in (
        ...
        _aliases("ing_banana", "banana", "bananas"),
        _aliases("ing_basil", "basil", "basil leaf", "basil leaves"),
        ...
        _aliases("ing_celery", "celery"),
        _aliases("ing_chickpea", "chickpea", "chickpeas", "garbanzo", "garbanzos"),
        ...
        _aliases("ing_cilantro", "cilantro", "coriander leaves"),
        _aliases("ing_corn_oil", "corn oil"),
        _aliases("ing_cornstarch", "cornstarch"),
        _aliases("ing_cooking_oil", "cooking oil", "vegetable oil", "oil"),
        _aliases("ing_crab", "crab", "alimango", "alimasag"),
        _aliases("ing_cucumber", "cucumber", "pipino"),
        _aliases("ing_egg", "egg", "eggs", "itlog"),
        _aliases("ing_eggplant", "eggplant", "eggplants", "talong"),
        ...
        _aliases("ing_kidney_bean", "kidney bean", "kidney beans", "red kidney bean", "red kidney beans"),
        _aliases("ing_lemon_juice", "lemon juice"),
        _aliases("ing_lettuce", "lettuce"),
        _aliases("ing_malunggay", "malunggay"),
        _aliases("ing_mayonnaise", "mayonnaise", "mayo"),
        _aliases("ing_milk", "milk", "gatas"),
        _aliases("ing_mussel", "mussel", "mussels", "tahong"),
        _aliases("ing_monggo", "monggo", "munggo", "mung bean", "mung beans", "monggo beans"),
        _aliases("ing_mushroom", "mushroom", "mushrooms", "button mushroom", "button mushrooms"),
        _aliases("ing_oats", "oat", "oats"),
        _aliases("ing_okra", "okra"),
        _aliases("ing_olive_oil", "olive oil"),
        _aliases("ing_onion_generic", "onion", "onions", "sibuyas"),
        _aliases("ing_onion_red", "red onion", "red onions"),
        _aliases("ing_onion_white", "white onion"),
        _aliases("ing_orange", "orange"),
        _aliases("ing_papaya", "papaya"),
        _aliases("ing_parsley", "parsley"),
        ...
        _aliases("ing_pineapple", "pineapple", "pineapples"),
        _aliases("ing_potato", "potato", "potatoes", "patatas", "baking potato"),
        ...
        _aliases("ing_sardines", "sardine", "sardines", "canned sardines"),
        _aliases("ing_scallion", "scallion", "scallions", "green onion", "green onions"),
        _aliases("ing_sesame_oil", "sesame oil"),
        _aliases("ing_sayote", "sayote"),
        _aliases("ing_shrimp", "shrimp", "shrimps", "hipon"),
        _aliases("ing_shrimp_paste", "shrimp paste", "bagoong alamang", "alamang"),
        ...
        _aliases("ing_sweet_potato", "sweet potato", "sweet potatoes", "kamote"),
        ...
        _aliases("ing_tomato", "tomato", "tomatoes", "native tomato", "native tomatoes", "kamatis"),
        ...
        _aliases("ing_annatto_oil", "annatto oil", "atsuete oil", "achuete oil"),
        _aliases("ing_honey", "honey"),
        _aliases("ing_hot_sauce", "hot sauce"),
    )
    for alias in group
)
...
INGREDIENT_ALLERGEN_LINKS: tuple[tuple[str, str, str, str], ...] = (
    ...
    ("ing_sardines", "fish", "contains", "high"),
    ("ing_shrimp", "shellfish", "contains", "high"),
    ("ing_shrimp_paste", "shellfish", "contains", "high"),
    ...
    ("ing_mayonnaise", "egg", "contains", "high"),
