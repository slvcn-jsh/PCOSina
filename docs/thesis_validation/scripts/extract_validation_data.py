...
def build_context() -> dict:
    ...
    citations = {
        ...
        "android_grocery_screen_pantry": cite("app/src/main/java/com/pcosina/app/ui/screens/GroceryListScreen.kt", "private fun pantryEntryMatchesGroceryItem"),
...
def write_gaps(ctx: dict) -> None:
    rows = [
        ...
        ["GAP-011", "Dedicated unit tests for the GroceryListScreen pantry-name matching edge case were not found.", f"{ctx['citations']['android_grocery_screen_pantry']}", "medium", "Add tests for single-token pantry entries versus multi-token grocery names.", "Chapters 4, 6"],
